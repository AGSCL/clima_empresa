...
skimr_encuesta2_rec %>% 
  ...
  dplyr::select(skim_type,skim_variable,var_lab, everything()) %>% 
  knitr::kable(.,format = "html", digits=2, format.args = list(decimal.mark = ".", big.mark = ","),
               caption = paste0("Tabla 1b. Resumen de Variables"),#,
               col.names = c("Tipo","Variable","Etiqueta","Perdidos","% Completos",
...
knitr::kable(format="markdown",caption= "Tabla 1b. Resumen de fechas")
```


<br>

```{r hist-comp-sos, echo=T, cache= T, paged.print=TRUE, warning=F, fig.cap="Figura 3a1. Histograma de Frecuencias, Puntajes Ítems de Compromiso Sostenible", fig.align="center",error=T}
...
```{r hist-comp-sos2, echo=T, cache= T, paged.print=TRUE, warning=F, fig.cap="Figura 3a2. Histograma de Frecuencias, Puntajes Ítems de Compromiso Sostenible (2022)", fig.align="center",error=T}
# paste0("comp_sos_",1:9), paste0("dllo_prof_",1:3), paste0("lid_",1:2), paste0("ent_trab_",1:2),paste0("covid_",1:4), paste0("intencion_",1), paste0("com_",1:2), paste0("ges_des_",1:2), paste0("comp_ben_",1:2), paste0("superv_",1:3)
...
```{r hist-dllo-prof, echo=T, cache= T, paged.print=TRUE, warning=F, fig.cap="Figura 3b. Histograma de Frecuencias, Puntajes Ítems de Desarrollo Profesional", fig.align="center",error=T}
p2<-
  encuesta_rec %>% 
...
```{r hist-covid, echo=T, cache= T, paged.print=TRUE, warning=F, fig.cap="Figura 3c. Histograma de Frecuencias, Puntajes Ítems de COVID-19", fig.align="center",error=T}
p3<-
    encuesta_rec %>% 
...
```{r hist-superv, echo=T, cache= T, paged.print=TRUE, warning=F, fig.cap="Figura 3d. Histograma de Frecuencias, Puntajes Ítems de Supervisor Inmediato", fig.align="center",error=T}
p4<-
    encuesta_rec %>% 
...
```{r hist-perdidos, echo=T, cache= T, paged.print=TRUE, warning=F, fig.cap="Figura 4. Histograma de Frecuencias, Valores perdidos en variables de interés", fig.align="center",error=T}
...
```{r hist-perdidos-2022, echo=T, cache= T, paged.print=TRUE, warning=F, fig.cap="Figura 4. Histograma de Frecuencias, Valores perdidos en variables de interés (2022)", fig.align="center",error=T}
...
```{r 2022-corr-felipe3,dpi = 320, message=F, error=T, eval=T, warnings=F, fig.height=5, fig.width=18}

cat("Asociación de compromiso sostenible, días desde el 25-07, estratificado por dirección (1,000 remuestreos)")
...
```{r 2022-corr-felipe3b,dpi = 320, message=F, error=T, eval=T, warnings=F, fig.height=5, fig.width=20}
cat("Asociación de compromiso sostenible y Feedback, estratificado por dirección (1,000 remuestreos)")
...
cat("Asociación de compromiso sostenible y Feedback (dicotomizada), estratificado por dirección (1,000 remuestreos)")
...
cat("Asociación de compromiso sostenible y Feedback, estratificado por dirección, descartando a quienes indican 0 recomendando a la empresa como un buen lugar para trabajar (1,000 remuestreos)")
...
cat("Asociación de compromiso sostenible y Feedback (dicotomizado), estratificado por dirección, descartando a quienes indican 0 recomendando a la empresa como un buen lugar para trabajar (1,000 remuestreos)")
ggstatsplot::grouped_ggbetweenstats(data = data.frame(encuesta2_rec) %>%  dplyr::mutate(group=dplyr::case_when(a_dir=="Operaciones"~"Operaciones",a_dir=="Ventas"~"Ventas",T~"Resto"),  ges_des_1_rec= factor(dplyr::case_when(ges_des_1=="Tiendo a estar de acuerdo"~1, ges_des_1=="De Acuerdo"~1, T~ 0),levels=c(0,1),labels=c("Otros","...de acuerdo/De acuerdo")))%>% dplyr::filter(enps_lugar_trab>0),
                            x = ges_des_1_rec,
                            y = compromiso_sostenible_ags,
                            ylab="Compromiso sostenible (suma)", 
...
cat("Asociación de compromiso sostenible y Feedback (dicotomizado), estratificado por dirección, descartando a quienes indican 6 o menos recomendando a la empresa como un buen lugar para trabajar (1,000 remuestreos)")
ggstatsplot::grouped_ggbetweenstats(data = data.frame(encuesta2_rec) %>%  dplyr::mutate(group=dplyr::case_when(a_dir=="Operaciones"~"Operaciones",a_dir=="Ventas"~"Ventas",T~"Resto"),  ges_des_1_rec= factor(dplyr::case_when(ges_des_1=="Tiendo a estar de acuerdo"~1, ges_des_1=="De Acuerdo"~1, T~ 0),levels=c(0,1),labels=c("Otros","...de acuerdo/De acuerdo")))%>% dplyr::filter(enps_lugar_trab>=7),
                            x = ges_des_1_rec,
                            y = compromiso_sostenible_ags,
                            ylab="Compromiso sostenible (suma)", 
...
encuesta2_rec %>%  dplyr::mutate(group=factor(dplyr::case_when(a_dir=="Operaciones"~"Operaciones",a_dir=="Ventas"~"Ventas",T~"Resto"), levels=c("Resto", "Ventas", "Operaciones")),  ges_des_1_rec= factor(dplyr::case_when(ges_des_1=="Tiendo a estar de acuerdo"~1, ges_des_1=="De Acuerdo"~1, T~ 0),levels=c(0,1),labels=c("Otros","...de acuerdo/De acuerdo"))) %>%
  dplyr::mutate(ges_des_1_rec= ff_label(ges_des_1_rec,"Feedback superiores")) %>% 
    finalfit("compromiso_sostenible_ags", c("group", "ges_des_1_rec", "dias_despues", "sexo", "antiguedad")) %>% knitr::kable("markdown")
...
`r finalfit(encuesta2_rec2,"compromiso_sostenible_ags", c("group", "ges_des_1_rec", "dias_despues", "sexo", "antiguedad"), metrics=T)[[2]]`
...
export2md(restab0_all, size=10, first.strip=T, hide.no="no", position="center",
          format="html",caption= "Tabla 2a. Descriptivo Aplicación Total (2022)",
...
export2md(restab1_all, size=10, first.strip=T, hide.no="no", position="center",
          format="html",caption= "Tabla 2b. Descriptivo Aplicación Total",
          col.names=c("Variables", "Todos los casos", "N")
         )%>%
  kableExtra::add_footnote(c("Note. N= Número de participantes con al menos una respuesta válida en las variables seleccionadas; Variables continuas se presentan como medianas y percentiles 25 y 75;", 
                             "Variables categóricas son presentadas como el recuento y el porcentaje"), notation = "none")%>%
...
```{r fig-sex, dpi = 320, warning=T,message=F,fig.align='center', fig.cap="Figura. Sexo", error=T, out.width='100%', eval=T}
library(plotly)
...
```{r fig-gerencia, dpi = 320, warning=T,message=F,fig.align='center', fig.cap="Figura. Gerencia", error=T, out.width="100%", eval=T, fig.height=10, fig.width=10}
...
```{r fig-comp-sos, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Compromiso Sostenible", fig.align="center",error=T}
invisible(c("Compromiso Sostenible", "Desarrollo Profesional", "Liderazgo",	"Entorno de Trabajo", "Covid", "Intención de permanecer en la Compañía",	"Comunicación",	"Gestión del Desempeño",	"Compensación y Beneficios",	"Supervisor Inmediato"))
#`
comp_sos_bars<-
encuesta_rec %>% 
...
```{r fig-comp-sos-b, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Compromiso Sostenible", fig.align="center",error=T, fig.height=8}
invisible(c("Compromiso Sostenible", "Desarrollo Profesional", "Liderazgo",	"Entorno de Trabajo", "Covid", "Intención de permanecer en la Compañía",	"Comunicación",	"Gestión del Desempeño",	"Compensación y Beneficios",	"Supervisor Inmediato"))
library(ggrepel)
comp_sos_bars %>% 
...
```{r fig-dllo-prof-1, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Desarrollo Profesional (1)", fig.align="center",error=T}
invisible(c("Compromiso Sostenible", "Desarrollo Profesional", "Liderazgo",	"Entorno de Trabajo", "Covid", "Intención de permanecer en la Compañía",	"Comunicación",	"Gestión del Desempeño",	"Compensación y Beneficios",	"Supervisor Inmediato"))
dllo_prof_bars<-
encuesta_rec %>% 
...
```{r dllo-prof-2, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Desarrollo Profesional (2)", fig.align="center",error=T, fig.height=8}
...
```{r fig-lid-ent-trab, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Liderazgo y Entorno de Trabajo", fig.align="center",error=T}
lid_ent_trab_bars<-
encuesta_rec %>% 
...
```{r fig-lid-ent-trab-2, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Liderazgo y Entorno de Trabajo (2)", fig.align="center",error=T, fig.height=8}
...
```{r fig-covid-19, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre COVID-19", fig.align="center",error=T}
covid_19_bars<-
encuesta_rec %>% 
...
```{r covid-19-2, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre COVID-19 (2)", fig.align="center",error=T, fig.height=8}
...
```{r otros-2, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Otras variables (2)", fig.align="center",error=T, fig.height=8}
...
```{r fig-superv1, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Supervisor/a", fig.align="center",error=T}
superv_bars<-
encuesta_rec %>% 
...
```{r superv-2, echo=T, cache= T, paged.print=TRUE, warning=T, fig.cap="Figura. Gráfico de Barras, Preguntas Sobre Supervisor/a (2)", fig.align="center",error=T, fig.height=8}
